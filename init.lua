...
require('lazy').setup({
  ...
  --MY SECOND EDIT. AUTO BRACKETING
  {
  ...
  -- MY THIRD EDIT. TAB OUT OF BRACKETS
  {
    ...
    config = function()
      require('tabout').setup {
        ...
        ignore_beginning = false, --[[ if true, if the cursor is at the beginning of a filled element it will rather tab out than shift the content ]]
